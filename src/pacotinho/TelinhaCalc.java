...
public class TelinhaCalc extends javax.swing.JFrame {

    public TelinhaCalc() {  // Construtor - Método com o msm nome da classe
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelinhaCalc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelinhaCalc().setVisible(true);
            }
        });
    }
